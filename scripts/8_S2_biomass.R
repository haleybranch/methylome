...
################### NORTH ############################################
#### WET ######
mod_nw <- lmer(dw~Rep + Site + PrePeak*Treatment_history + (1|S0_ID), data=dat_north_wet)
...
################### SOUTH ############################################
#### WET ######
mod_sw <- lmer(dw~Rep + Site + PrePeak*Treatment_history + (1|S0_ID), data=dat_south_wet)
...
effsize_sw
#write.csv(effsize_sw, "Results/biomass_sw_effectsize.csv")
...
effsize_sd
#write.csv(effsize_sd, "Results/biomass_sd_effectsize.csv")
